...
public class ElitisticListPopulation16_ESTest extends ElitisticListPopulation16_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      ...
      ElitisticListPopulation elitisticListPopulation0 = null;
      try {
        elitisticListPopulation0 = new ElitisticListPopulation(linkedList0, 2456, 2456);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test08()  throws Throwable  {
      LinkedList<Chromosome> linkedList0 = new LinkedList<Chromosome>();
      ElitisticListPopulation elitisticListPopulation0 = new ElitisticListPopulation(linkedList0, 1992, 1.0);
  ...
  public void test10()  throws Throwable  {
      ...
      ElitisticListPopulation elitisticListPopulation0 = new ElitisticListPopulation(linkedList0, 1992, 1.0);
      try { 
        elitisticListPopulation0.setElitismRate(554.5605239025);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // elitism rate (554.561)
         //
         verifyException("math.genetics.ElitisticListPopulation", e);
      }
  }

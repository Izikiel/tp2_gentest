...
public class ElitisticListPopulation1_ESTest extends ElitisticListPopulation1_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      ElitisticListPopulation elitisticListPopulation0 = null;
      try {
        elitisticListPopulation0 = new ElitisticListPopulation(linkedList0, 127, 127);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test03()  throws Throwable  {
      ElitisticListPopulation elitisticListPopulation0 = null;
      try {
        elitisticListPopulation0 = new ElitisticListPopulation((List<Chromosome>) null, (-3663), 1558.586408011984);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test04()  throws Throwable  {
      ElitisticListPopulation elitisticListPopulation0 = null;
      try {
        elitisticListPopulation0 = new ElitisticListPopulation((-456), (-1.0));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test05()  throws Throwable  {
      ElitisticListPopulation elitisticListPopulation0 = null;
      try {
        elitisticListPopulation0 = new ElitisticListPopulation(1, 1113.943484809);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // elitism rate (1,113.943)
         //
         verifyException("math.genetics.ElitisticListPopulation", e);
      }
  }
  ...
  public void test06()  throws Throwable  {
      LinkedList<Chromosome> linkedList0 = new LinkedList<Chromosome>();
      ElitisticListPopulation elitisticListPopulation0 = new ElitisticListPopulation(linkedList0, 4311, 0.0);
      double double0 = elitisticListPopulation0.getElitismRate();
  ...
  public void test07()  throws Throwable  {
      ...
      try { 
        elitisticListPopulation0.setElitismRate(195.0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test08()  throws Throwable  {
      ElitisticListPopulation elitisticListPopulation0 = new ElitisticListPopulation(1, 1.0);
      try { 
        elitisticListPopulation0.setElitismRate((-273.7688433444345));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // elitism rate (-273.769)
         //
         verifyException("math.genetics.ElitisticListPopulation", e);
      }
  }

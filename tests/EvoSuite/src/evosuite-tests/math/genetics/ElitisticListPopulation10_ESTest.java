...
public class ElitisticListPopulation10_ESTest extends ElitisticListPopulation10_ESTest_scaffolding {

  @Test(timeout = 4000)
  public void test00()  throws Throwable  {
      ElitisticListPopulation elitisticListPopulation0 = new ElitisticListPopulation(375, 0.0);
  ...
  public void test03()  throws Throwable  {
      ElitisticListPopulation elitisticListPopulation0 = null;
      try {
        elitisticListPopulation0 = new ElitisticListPopulation((List<Chromosome>) null, 310, 751.0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test04()  throws Throwable  {
      ElitisticListPopulation elitisticListPopulation0 = null;
      try {
        elitisticListPopulation0 = new ElitisticListPopulation(0, 1821.0190684);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test06()  throws Throwable  {
      ElitisticListPopulation elitisticListPopulation0 = new ElitisticListPopulation(375, 0.0);
      try { 
        elitisticListPopulation0.setElitismRate(625.810783957687);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // elitism rate (625.811)
         //
         verifyException("math.genetics.ElitisticListPopulation", e);
      }
  }
  ...
  public void test07()  throws Throwable  {
      ...
      try { 
        elitisticListPopulation0.setElitismRate((-1687.0));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test08()  throws Throwable  {
      ElitisticListPopulation elitisticListPopulation0 = new ElitisticListPopulation(1743, 0.0);
      elitisticListPopulation0.setElitismRate(0.0);
      assertEquals(1743, elitisticListPopulation0.getPopulationLimit());
  }
  ...
  public void test10()  throws Throwable  {
      ...
      ElitisticListPopulation elitisticListPopulation0 = null;
      try {
        elitisticListPopulation0 = new ElitisticListPopulation(linkedList0, 2266, 2266);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test12()  throws Throwable  {
      ...
      ElitisticListPopulation elitisticListPopulation1 = new ElitisticListPopulation(list0, 1743, 0.0);

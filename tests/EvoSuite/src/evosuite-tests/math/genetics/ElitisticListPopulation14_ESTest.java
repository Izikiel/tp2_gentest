...
public class ElitisticListPopulation14_ESTest extends ElitisticListPopulation14_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ElitisticListPopulation elitisticListPopulation0 = new ElitisticListPopulation(4424, 0.0);
  ...
  public void test02()  throws Throwable  {
      ...
      try {
        elitisticListPopulation0 = new ElitisticListPopulation(linkedList1, (-3511), (-3511));
  ...
  public void test03()  throws Throwable  {
      ...
      try {
        elitisticListPopulation1 = new ElitisticListPopulation(list0, 211, 211);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test04()  throws Throwable  {
      ElitisticListPopulation elitisticListPopulation0 = null;
      try {
        elitisticListPopulation0 = new ElitisticListPopulation((-779), (-779));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test05()  throws Throwable  {
      ElitisticListPopulation elitisticListPopulation0 = null;
      try {
        elitisticListPopulation0 = new ElitisticListPopulation(2809, 2809);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test07()  throws Throwable  {
      ElitisticListPopulation elitisticListPopulation0 = new ElitisticListPopulation(1191, 0.0);
      double double0 = elitisticListPopulation0.getElitismRate();
  ...
  public void test08()  throws Throwable  {
      ...
      try { 
        elitisticListPopulation0.setElitismRate(1466.3077);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // elitism rate (1,466.308)
         //
         verifyException("math.genetics.ElitisticListPopulation", e);
      }
  }
  ...
  public void test11()  throws Throwable  {
      ElitisticListPopulation elitisticListPopulation0 = null;
      try {
        elitisticListPopulation0 = new ElitisticListPopulation((List<Chromosome>) null, 12, 0.0);
        fail("Expecting exception: IllegalArgumentException");

...
public class FixedOrderComparator12_ESTest extends FixedOrderComparator12_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try { 
        fixedOrderComparator0.setUnknownObjectBehavior(212);
  ...
  public void test07()  throws Throwable  {
      LinkedList<String> linkedList0 = new LinkedList<String>();
      linkedList0.add("hJbF");
      FixedOrderComparator fixedOrderComparator0 = new FixedOrderComparator(linkedList0);
      boolean boolean0 = fixedOrderComparator0.add("hJbF");
      assertEquals(2, fixedOrderComparator0.getUnknownObjectBehavior());
  ...
  public void test10()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        fixedOrderComparator0.compare(object0, "Attempting to compare unknown object ");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Attempting to compare unknown object java.lang.Object@4f816a31
         //
         verifyException("collections.comparators.FixedOrderComparator", e);
      }
  }
  ...
  public void test12()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        fixedOrderComparator0.compare(object0, "-;@T{");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Attempting to compare unknown object -;@T{
         //
         verifyException("collections.comparators.FixedOrderComparator", e);
      }
  }
  ...
  public void test14()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        fixedOrderComparator0.addAsEqual("zdWe|lwe@9m5/", objectArray0[2]);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // zdWe|lwe@9m5/ not known to collections.comparators.FixedOrderComparator@1
         //
         verifyException("collections.comparators.FixedOrderComparator", e);
      }
  }
  ...
  public void test17()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        fixedOrderComparator0.setUnknownObjectBehavior((-740));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test18()  throws Throwable  {
      ...
      FixedOrderComparator fixedOrderComparator0 = new FixedOrderComparator(objectArray0);
      fixedOrderComparator0.setUnknownObjectBehavior(0);
      fixedOrderComparator0.compare("\"$/<ATSxWh;K~2aIoE", object0);
      // Undeclared exception!
      try { 
        fixedOrderComparator0.addAsEqual(objectArray0[0], "\"$/<ATSxWh;K~2aIoE");
        fail("Expecting exception: UnsupportedOperationException");
